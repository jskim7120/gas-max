...
import { Plus, Trash, Reset, MagnifyingGlassBig } from "components/allSvgIcon";
    ...
    <>
      ...
      <WrapperContent>
        <form onSubmit={handleSubmit(submit)} autoComplete="off">
          <SearchWrapper style={{ justifyContent: "flex-start" }}>
            <div>
              <FormGroup>
                ...
                <Label style={{ minWidth: "134px" }}>사원</Label>
              ...
              <FormGroup>
                ...
                <Label style={{ minWidth: "100px", marginRight: "5px" }}>
                  거래 구분
                </Label>
                <FormGroup
                  style={{

...
export const schema = yup.object({
  ...
  areaName: yup.string().typeError("This field is required"),
  ...
  jnSekum: yup.string().typeError("This field is required"),

  jnVatSumyn: yup.string().nullable(),
  jnSekumEa: yup.string().nullable(),
  jnJangbu: yup.string().typeError("This field is required"),
